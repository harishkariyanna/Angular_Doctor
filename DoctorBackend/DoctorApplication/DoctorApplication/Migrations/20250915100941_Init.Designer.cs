...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorApplication.Models.Hospital", b =>
                {
                    b.Property<string>("HospitalId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DoctorApplication.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("DoctorApplication.Models.User", b =>
                {
            ...
            modelBuilder.Entity("DoctorApplication.Models.Doctor", b =>
                {
                    b.HasOne("DoctorApplication.Models.Hospital", "Hospital")
                        .WithMany("Doctors")
            ...
            modelBuilder.Entity("DoctorApplication.Models.User", b =>
                {
                    b.HasOne("DoctorApplication.Models.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("DoctorPatients", b =>
                {
                    b.HasOne("DoctorApplication.Models.Doctor", null)
                        .WithMany()
                        .HasForeignKey("DoctorsDoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DoctorApplication.Models.Patient", null)
                        .WithMany()
